    ...
    - generic [ref=e76]:
      ...
      - insertion [ref=e98]:
        - generic [ref=e101]:
          ...
          - link "Flora & Fauna" [ref=e119] [cursor=pointer]
          - link "Development Tools" [ref=e124] [cursor=pointer]
          - link "Quality Control & Tracking" [ref=e129] [cursor=pointer]
          - link "Automation practice website" [ref=e134] [cursor=pointer]
          - link "Software testing resources" [ref=e139] [cursor=pointer]
      - generic [ref=e144]:
...
```ts
  ...
  16 |     this.loginHeader = page.locator('h2:text("Login to your account")');
